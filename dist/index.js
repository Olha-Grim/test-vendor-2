...
var Icon$1 = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderInnerNode = function renderInnerNode() {
    ...
    if (children) {
      warning$2(Boolean(viewBox) || React.Children.count(children) === 1 && /*#__PURE__*/React.isValidElement(children) && React.Children.only(children).type === 'use', 'Make sure that you provide correct `viewBox`' + ' prop (default `0 0 1024 1024`) to the icon.');
...
var CommonIcon = function CommonIcon(_ref) {
  var className = _ref.className,
      ...
      spin = _ref.spin,
      style = _ref.style,
      twoToneColor = _ref.twoToneColor,
      component = _ref.component;
  var props = {
    className: className,
    rotate: rotate,
