 ...
 * @param {Props} props
 */
declare function notification({ bottom, btn, className, closeIcon, description, duration, getContainer, icon, key, message, placement, style, top, onClick, onClose, }: Props): JSX.Element;
