...
export type Props = {
    ...
    filter: (inputValue: string, path: CascaderValueType[], names: FilledFieldNamesType) => boolean;
    limit: number | false;
    matchInputWidth: boolean;
    render: (a: CascaderOptionType[], b: CascaderOptionType[], inputValue: string, names: FilledFieldNamesType) => number;
